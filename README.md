...
â”œâ”€â”€ Dockerfile                   # Container definition for inference service
â”œâ”€â”€ entrypoint.sh                # Container startup script
â”œâ”€â”€ log.sh                       # Utility for viewing logs
â”œâ”€â”€ README.md                    # This documentation file
â”œâ”€â”€ requirements.txt             # Dependencies for deployment
â”œâ”€â”€ run.sh                       # Script to run the service
â”œâ”€â”€ clean.sh                     # Script to clean deployment and files
â”œâ”€â”€ ml_inference/
â”‚   â”œâ”€â”€ inference.py             # Main inference service code
â”‚   â””â”€â”€ models/
â”‚       â”œâ”€â”€ rb/                # RB router-specific models directory
â”‚       â”‚   â”œâ”€â”€ deep_neural_network/     # Deep Neural Network models
â”‚       â”‚   â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚       â”‚   â”‚   â”œâ”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚       â”‚   â”‚   â””â”€â”€ scaler_v1.0.0.pkl     # Feature scaler for normalization
â”‚       â”‚   â”œâ”€â”€ linear_regression/       # Linear regression models
â”‚       â”‚   â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚       â”‚   â”‚   â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚       â”‚   â”œâ”€â”€ polynomial_regression/   # Polynomial regression models
â”‚       â”‚   â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚       â”‚   â”‚   â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚       â”‚   â””â”€â”€ random_forest/           # Random Forest models
â”‚       â”‚       â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚       â”‚       â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚       â””â”€â”€ ra/              # RA router-specific models directory
â”‚           â”œâ”€â”€ deep_neural_network/     # Deep Neural Network models
â”‚           â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚           â”‚   â”œâ”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚           â”‚   â””â”€â”€ scaler_v1.0.0.pkl     # Feature scaler for normalization
â”‚           â”œâ”€â”€ linear_regression/       # Linear regression models
â”‚           â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚           â”‚   â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚           â”œâ”€â”€ polynomial_regression/   # Polynomial regression models
â”‚           â”‚   â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚           â”‚   â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â”‚           â””â”€â”€ random_forest/           # Random Forest models
â”‚               â”œâ”€â”€ model_v1.0.0.pkl      # Trained model serialized object
â”‚               â””â”€â”€ metadata_v1.0.0.yaml  # Model metadata (features, metrics)
â””â”€â”€ telemetry_mock/
    â”œâ”€â”€ Dockerfile               # Container definition for mock service
    â”œâ”€â”€ requirements.txt         # Dependencies for mock service
    â”œâ”€â”€ telemetry_mock.py        # Mock telemetry service implementation
    â”œâ”€â”€ plots/                   # Directory for validation plots
    â”œâ”€â”€ outputs/                 # Output data storage
    â”‚   â”œâ”€â”€ mock_data/           # Outputs from synthetic data
    â”‚   â””â”€â”€ test_data/           # Outputs from experiment data
    â””â”€â”€ data/                    # Test data for mock service (mounted to /app/data)
        â”œâ”€â”€ mock_data/           # Template files for synthetic inputs
        â”‚   â””â”€â”€ input_ml_metrics.json     # Input message template
        â””â”€â”€ test_data/           # Test datasets from experiments
            â””â”€â”€ ra/          # Router-specific test data
                â”œâ”€â”€ ExperimentoA1_test_data.csv   # Test data from experiment A1
                â”œâ”€â”€ ExperimentoA3_test_data.csv   # Test data from experiment A3
                â””â”€â”€ ExperimentoA4_test_data.csv   # Test data from experiment A4
```
...
- **Training Data**: 4 datasets from ExperimentoA3 and ExperimentoA4 (July 2025)
- **Test Data**: 2 datasets from ExperimentoA3 and ExperimentoA4 (June-July 2025)
...
The RA router models are trained on TelefÃ³nica's historical router telemetry data and provide established baseline performance for comparison and deployment.
...
- **ra**: RA router models (fully implemented)
  ...
  - Trained on TelefÃ³nica's historical router telemetry data
...
- `node_network_average_received_packet_length` â†’ `PacketSize_B`
- `node_network_router_capacity_occupation` â†’ `Throughput_Percentage`
